...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Stuti Agrawal, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
    "I’m currently a undergraduate student trying to bring visions to life through interactive digital solutions.",
  resumeLinkText: "Download Resume",
  resumeLink: "personal port/public/Stuti_Resume_May_2025.pdf",
};
...
export const CONTACT_CONTENT = {
  ...
  footerText: `Made with ❤️ © ${new Date().getFullYear()} Stuti Agrawal.`,
};
